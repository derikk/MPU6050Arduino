...
float angle_pitch_sum; 
float angle_roll_sum;
...
void loop(){
  ...
  //for(int i = 0; i<100, i++;){
    ...
    //angle_pitch_sum = angle_pitch_sum + angle_pitch_output;
    //angle_roll_sum = angle_roll_sum + angle_roll_output;
  //}
...
void printdata(){
  ...
  Serial.println(" ");
  //Serial.print(angle_pitch_sum / 10);
  //Serial.print(" ");
  //Serial.print(angle_roll_sum / 10);
  //Serial.println(" ");
}
